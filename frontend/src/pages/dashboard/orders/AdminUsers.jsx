        ...
        <div className="bg-white rounded-lg shadow p-6 text-center">
          ...
          {searchTerm && (
            <button
              ...
              className="mt-3 text-blue-500 hover:text-blue-700 text-sm sm:text-base"
            >
              Clear search
            </button>
          )}
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredUsers.map((user, idx) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 space-x-2 sm:space-x-3">
                      <button
